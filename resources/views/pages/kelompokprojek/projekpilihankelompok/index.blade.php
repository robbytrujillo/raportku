          ...
          <div class="card-header">
            ...
            <div class="mt-3">
              <button class="btn btn-sm float-left btn-primary btn-icon-split create-button">
                ...
                Tambah Projek <span class="d-xs-none">Pilihan Kelompok</span>
              </button>
              <a href="/anggotakelompok/{{$kelompokprojek->id }}" class="btn btn-warning btn-sm mx-1 float-right">
...
@include('pages.kelompokprojek.projekpilihankelompok._create')
@include('pages.kelompokprojek.projekpilihankelompok._show')

@endsection

@section('js')
  @include('partials.toast2');
  @include('pages.kelompokprojek.projekpilihankelompok.script')
@endsection
