  ...
  <div class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              <h4 class="modal-title fw-bold ">Import Data Guru</h4>
          ...
          @csrf
            ...
            <div class="modal-body">
              ...
              <div class="alert alert-warning alert-dismissible fade show" role="alert" id="alert-info">
                ...
                <a href="/import/FORMAT IMPORT DATA GURU RAPORT MERDEKA.xlsx" class="text-primary" download>Download Format Import</a>
