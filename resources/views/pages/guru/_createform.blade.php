<div class="col-md-6">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="number" name="nip" value="{{ old('nip') }}" class="form-control @error('nip') is-invalid @enderror" id="nip" placeholder="Ketik NIP">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" name="nuptk" value="{{ old('nuptk') }}" class="form-control @error('nuptk') is-invalid @enderror" id="nuptk" placeholder="Ketik NUPTK" >
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" name="tempatlahir" value="{{ old('tempatlahir') }}" class="form-control @error('tempatlahir') is-invalid @enderror" id="tempatlahir" placeholder="Ketik Tempat Lahir">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="date" name="tanggallahir" value="{{ old('tanggallahir') }}" class="form-control @error('tanggallahir') is-invalid @enderror" id="tanggallahir" placeholder="Ketik Tanggal Lahir">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="number" name="telepon" value="{{ old('telepon') }}" class="form-control @error('telepon') is-invalid @enderror" id="telepon" placeholder="Ketik Telepon" >
...
<div class="col-md-6">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      ...
      <img id="preview-ttd" src="#" style="display:none; margin-top:10px; max-height:80px;">
    </div>
  </div>
