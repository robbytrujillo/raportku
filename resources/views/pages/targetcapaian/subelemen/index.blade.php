            ...
            <div class="table-responsive">
              <table id="myTable" class="table table-sm table-hover mb-0">
                ...
                <tr class="bg-dark text-white header-table {{ Auth::user()->dark_mode == '1' ? 'bg-light' : '' }}">
                  <th scope="col">No.</th>
                  <th scope="col">Nama Sub Elemen</th>
                  <th scope="col">Jumlah Capaian Akhir</th>
...
@include('pages.targetcapaian.subelemen._create')
@include('pages.targetcapaian.subelemen._edit')
@include('pages.targetcapaian.subelemen._delete')

@endsection

@section('js')
  @include('partials.toast2');
 @include('pages.targetcapaian.subelemen.script')
@endsection
