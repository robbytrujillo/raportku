<script>
  $(document).ready(function(){
    $('#myTable').dataTable({
      ...
      ordering: false,
      ajax: {
        url: '{{ route('dimensi.index') }}',
      },
      columns: [
        {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: true, searchable: false},
        {data: 'name', name: 'name'},
        {data: 'elemen.count', name: 'elemen.count'},
        {data: 'aksi', name: 'aksi'},
      ]
    });
    ...
    $('body').on('click', '.show-button', function(){
      loadAMoment();
      window.location.href = '/elemen/' + $(this).data('id');
    });
