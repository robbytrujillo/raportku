              ...
              <div class="table-responsive">
                <table id="myTable" class="table table-sm table-hover mb-0">
                  ...
                  <tr class="bg-dark text-white header-table {{ Auth::user()->dark_mode == '1' ? 'bg-light' : '' }}">
                    ...
                    <th scope="col">Jumlah Sub Elemen</th>
...
@include('pages.targetcapaian.elemen._create')
@include('pages.targetcapaian.elemen._edit')
@include('pages.targetcapaian.elemen._delete')

@endsection

@section('js')
  @include('partials.toast2');
 @include('pages.targetcapaian.elemen.script')
@endsection
