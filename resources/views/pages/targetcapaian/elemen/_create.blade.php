    ...
    <form action="#" id="form-create">
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title fw-bold ">Tambah Data Elemen</h5>
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control create-field" name="name" id="create-name" rows="2" placeholder="Ketik Nama Elemen" required></textarea>
