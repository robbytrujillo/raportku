<div class="col-md-6">
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" name="name" value="{{ old('name', $admin->name) }}" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Ketik Nama" required>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="number" name="nip" value="{{ old('nip', $admin->nip) }}" class="form-control @error('nip') is-invalid @enderror" id="nip" placeholder="Ketik NIP">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" name="nuptk" value="{{ old('nuptk', $admin->nuptk) }}" class="form-control @error('nuptk') is-invalid @enderror" id="nuptk" placeholder="Ketik NUPTK" >
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" name="tempatlahir" value="{{ old('tempatlahir', $admin->tempatlahir) }}" class="form-control @error('tempatlahir') is-invalid @enderror" id="tempatlahir" placeholder="Ketik Tempat Lahir">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="date" name="tanggallahir" value="{{ old('tanggallahir', $admin->tanggallahir) }}" class="form-control @error('tanggallahir') is-invalid @enderror" id="tanggallahir" placeholder="Ketik Tanggal Lahir">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <textarea type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="alamat" placeholder="Ketik Alamat" >{{ old('alamat', $admin->alamat) }}</textarea>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="number" name="telepon" value="{{ old('telepon', $admin->telepon) }}" class="form-control @error('telepon') is-invalid @enderror" id="telepon" placeholder="Ketik Telepon" >
...
<div class="col-md-6">
  <div class="form-group row">
    <label for="is_aktif" class="col-sm-3 col-form-label">Status Admin @include('partials._wajib')</label>
    <div class="col-sm-9">
      <select name="is_aktif" id="is_aktif" class="form-control @error('is_aktif') is-invalid @enderror" data-width="100%" required>
        <option disabled selected hidden>-- Pilih --</option>
        <option value="1" {{ old('is_aktif', $admin->user->is_aktif) == '1' ? 'selected' : '' }}>AKTIF</option>
        <option value="0" {{ old('is_aktif', $admin->user->is_aktif) == '0' ? 'selected' : '' }}>NON-AKTIF</option>
      </select>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="email" name="email" value="{{ old('email', $admin->user->email) }}" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Ketik Email" >
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="username" name="username" value="{{ old('username', $admin->user->username) }}" class="form-control @error('username') is-invalid @enderror" id="username" placeholder="Ketik Username" required>
