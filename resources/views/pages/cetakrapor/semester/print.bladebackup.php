...
<body>
    ...
    <div class="invoice-box">
        ...
        <div class="content">
            ...
            <table cellspacing="0">
                ...
                <tr class="nilai">
                    ...
                    <td class="center">
                        {{ $siswa->nilaiAkhir->where('pembelajaran_id', $pemb->id)->first()->nilai ?? '-'; }}</td>
                    <td>
                        <span>{{ $siswa->nilaiAkhir->where('pembelajaran_id', $pemb->id)->first()->deskripsi_capaian_tinggi ?? null; }}
                        </span>
                        <span
                            style="display: flex;">{{ $siswa->nilaiAkhir->where('pembelajaran_id', $pemb->id)->first()->deskripsi_capaian_rendah ?? null; }}
                        </span>
                    </td>
                </tr>
                @endforeach
        ...
        <div class="footer" style="font-family: 'Times New Roman'; font-weight: bold;">
            <i>{{$siswa->kelas->name}} | {{$siswa->name}} | {{$siswa->nis}}</i> <b style="float: right;"><i>Halaman
                    1</i></b>
        </div>
        {{-- END FOOTER --}}
            ...
            <table cellspacing="0">
                ...
                <tr class="sikap">
                    <td colspan="4" class="description" style="height: 50px;">
                        ...
                        @if ($siswa->kelas->tingkat->angka == 6 || $siswa->kelas->tingkat->angka == 9 ||
                        $siswa->kelas->tingkat->angka == 12)
                        <b>TIDAK LULUS</b>
                        @else
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 35%;">
                        ...
                        {{ Carbon::createFromFormat('Y-m-d', Str::before($siswa->kelas->tapel->tanggal, ' '))->locale('id')->isoFormat('D MMMM YYYY') ?? 'Tanggal'}},
                        <br>
