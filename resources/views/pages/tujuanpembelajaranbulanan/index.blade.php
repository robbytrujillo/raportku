...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-1">
      <div class="col-sm-6">
        <h4 class="m-0 fw-bold">Data Tujuan Pembelajaran Bulanan</h4>
      </div>
    </div>
  </div>
</div>
...
@include('pages.tujuanpembelajaranbulanan._filter')

@endsection

@section('js')
 @include('partials.toast2')
 @include('pages.tujuanpembelajaranbulanan._scriptindex')
@endsection
