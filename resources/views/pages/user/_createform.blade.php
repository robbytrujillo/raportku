<div class="form-group row">
  ...
  <div class="col-sm-10">
    <input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Ketik Nama" >
...
<div class="form-group row">
  ...
  <div class="col-sm-10">
    <select name="role" id="role" class="form-control selectTwo @error('role') is-invalid @enderror" data-width="100%" >
      ...
      <option value="opt1" {{ old('role') == 'opt1' ? 'selected' : '' }}>Option 1</option>
      <option value="opt2" {{ old('role') == 'opt2' ? 'selected' : '' }}>Option 2</option>
    </select>
...
<div class="form-group row">
  ...
  <label for="password" class="col-sm-2 col-form-label">Password @include('partials._wajib')</label>
